		...
		<div class="container wrapper" id="content-main">
			...
			<div class="row my-5 content-section">
				...
				<div class="secession-area">
					<div class="col-md-12">
					<textarea class="form-control" readonly rows="10" cols="100" style="resize: none;">
제1조
이 약관은 샘플 약관입니다.
...
④ 약관 내용 4
					...
					<div class="row mb-4 form-row" style="padding-left : 150px;">
						...
						<button type="submit" class="btn btn-secondary btn-block btn-size">
							탈퇴</button>
						<button type="button" class="btn btn-teal btn-block btn-size" onclick="location.href='#'">돌아가기</button>
					</div>
					<!-- </form> -->
				</div>
